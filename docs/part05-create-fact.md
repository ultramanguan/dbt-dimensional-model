...
As in [Part 4](part04-create-dimension.md#step-8-build-dbt-models), `dbt build` is used here so the project's snapshot runs before the models that depend on it.
